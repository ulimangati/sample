...
<![endif]-->
    ...
    <body>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            ...
            <br>
            <div class="btn-group" style="width:100%">
                <button style="width:33.3%"><a href="ordered_report_m.php">Ordered Report</a></button>
                <button style="width:33.3%"><a href="delivered_report_m.php">Delivered Report</a></button>
                <button style="width:33.3%"><a href="sold_item_report_m.php">Sold Item Report</a></button>
            </div>



            <div ng-app="orderedtablem" ng-controller="controller">
                <br/>
                <br/>
                <div class="row">
            ...
            <script src="../js/orderedtablem.js"></script>
