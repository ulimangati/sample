...
$inventorybranchid = $_POST['inventorybranchid'];
$updatequery =("UPDATE products SET status = 'archivestatus' WHERE branchid='inventorybranchid'");
}
?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="yesarchive">Yes</button>
                </div>
            </div>
        </div>
    </div>
